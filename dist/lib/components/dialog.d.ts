...
declare function Dialog({ defaultOpen, onOpenChange, open, children, isAlert }: {
    children: React.ReactNode | (({ open, setOpen, }: {
        open: boolean;
...
declare const DialogContent: React.ForwardRefExoticComponent<Omit<{
    ...
    enterKeyHint?: "send" | "search" | "enter" | "done" | "go" | "next" | "previous" | undefined;
