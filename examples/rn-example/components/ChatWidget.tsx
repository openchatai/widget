...
export const ChatWidget = () => {
  ...
  const { chat, prelude, isLoading, preludeError, retryPrelude } =
    useChatContext();
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert("Error", "Failed to reset chat. Please try again.");
            } finally {
    ...
    return (
      <SafeAreaView style={styles.loadingContainer}>
        <View style={styles.errorContent}>
          ...
          <TouchableOpacity style={styles.retryButton} onPress={retryPrelude}>
            ...
            <View style={styles.connectionStatus}>
              <View
                style={[
                  styles.statusDot,
                  {
                    backgroundColor: chatState?.loading.isLoading
                      ? "#f59e0b"
                      : "#10b981",
                  },
                ]}
          ...
          {chatState?.messages.map((message: MessageType, index: number) => (
            ...
            >
              ...
              >
                {message.type === "FROM_USER"
                  ? message.content
                  : (message as BotMessageType<{ message: string }>).data
                      .message}
              </Text>
            </View>
          ))}
