...
function useWidgetSoundEffects() {
    ...
    const messageArrivedSound = useSound(soundEffectFiles.messageArrived, { soundEnabled });
    const ticketResolvedSound = useSound(soundEffectFiles.messageArrived, { soundEnabled });
