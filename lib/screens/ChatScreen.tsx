...
function ChatFooter() {
  ...
  return (
    <div className="p-2 rounded-lg relative">
      ...
      <div className="flex items-center gap-2 border px-2 py-1.5 rounded-lg" style={{
        background: "#FFFFFF",
  ...
  return (
    <TooltipProvider>
      <div className="size-full flex flex-col overflow-hidden bg-background z-10 origin-bottom absolute bottom-0 inset-x-0">
        <div className="w-full mesh-gradient h-full justify-between rounded-t-xl flex flex-col relative overflow-auto" style={{
...
function HeaderChatRunning() {
  ...
  return (
    <header className="p-3 gap-2 flex flex-col" style={{
      paddingBottom: "1rem"
    }}>
...
function HeaderChatDidNotStart() {
  const { session, clearSession, settings, setSettings } = useChat();
  return (<header className="p-3 gap-2 flex flex-col" style={{
    paddingBottom: "2rem"
  }}>
    <div className="w-full flex items-center justify-between">
      <Dialog>
    ...
    <div className="flex items-center justify-center flex-col">
      ...
      <h2 className="text-lg font-semibold text-background text-center" style={{
        textShadow: "0px 2px 8px rgba(0, 0, 0, 0.12)"
      }}>
        Got any question? Chat with us!
      </h2>

      <span className="text-sm text-white text-center" style={{
        textShadow: "0px 2px 8px rgba(0, 0, 0, 0.12)"
      }}>
