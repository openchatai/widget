  ...
  return (
    <div className="w-full relative py-3 my-2" data-test="chat-event-container">
      <span
        ...
        data-test="chat-event-divider"
      />
      <p
        className="text-secondary-foreground absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 bg-secondary p-1 text-xs rounded-lg w-fit text-center font-medium shadow-sm"
        data-test="chat-event-message"
      >
        {props.data.message}
      </p>
    </div>
